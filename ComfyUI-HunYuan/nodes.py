...
class DiffusersPipelineLoader:
    ...
    def create_pipeline(self, pipeline_folder_name):
  

        args_hunyuan = get_args()
        #print(os.path.join(HUNYUAN_PATH, pipeline_folder_name))
        gen = End2End(args_hunyuan[0], Path(os.path.join(HUNYUAN_PATH, pipeline_folder_name)))
        #print(gen)
        return (gen, )
